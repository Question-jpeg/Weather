...
struct ContentView: View {
    ...
    @State private var lightningForkProbability = 50.0
    
    @State private var meteorShowerIntensity = 1.0
    ...
    let starOpacityStops: [Gradient.Stop] = [
    ...
    var body: some View {
        ZStack {
            StarsView(meteorShowerIntensity: meteorShowerIntensity)
                .opacity(starOpacity)
            CloudsView(
            ...
            VStack {
                ...
                if showingControls {
                    VStack {
                        ...
                        HStack {
                            Text("Max Bolts:")
                            Slider(value: $lightningMaxBolts, in: 0...10, step: 1)
                        }
                        .padding(.horizontal)
                        
                        HStack {
                            Text("Fork %:")
                            Slider(value: $lightningForkProbability, in: 0...100, step: 1)
                        }
                        .padding(.horizontal)
                        
                        HStack {
                            Text("Meteor Intensity:")
                            Slider(value: $meteorShowerIntensity, in: 0.1 ... 10)
                        }
                        .padding(.horizontal)
                    }
